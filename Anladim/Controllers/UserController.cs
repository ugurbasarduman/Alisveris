...
namespace Anladim.Controllers
{
    ...
    //            var isExist = IsEmailExist(user.Mail);
    //            if (isExist)
    //            {
    ...
    //            //Send Email to User
    //            SendVerificationLinkEmail(user.Mail, user.ActivationCode.ToString());
    //            message = "Registration successfully done. Account activation link " +
    //                " has been sent to your email id:" + user.Mail;
    //            Status = true;
    ...
    //    {
    //        var v = dc.Users.Where(a => a.Mail == mail).FirstOrDefault();
    //        return v != null;
    ...
    //    [HttpPost]
    //    [ValidateAntiForgeryToken]
    //    public ActionResult LoginDemo(UserLogin login, string ReturnUrl = "")
    //    {
    //        string message = "";
            
    //        var v = dc.Users.Where(a => a.Mail == login.Mail).FirstOrDefault();
    //        if (v != null)
    //        {
